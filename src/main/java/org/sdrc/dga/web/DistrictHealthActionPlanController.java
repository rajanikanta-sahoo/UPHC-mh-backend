...
public class DistrictHealthActionPlanController {
	...
	@ResponseBody
	public List<TimePeriod> getLatestTimeperiod(@RequestParam("stateId") int stateId){
		List<TimePeriod> timePeriods = new ArrayList<>();
		timePeriods.add(timePeriodRepository.findTop1ByStateidOrderByTimePeriodIdDesc(stateId));
		return timePeriods;
	}
