				...
				for (FacilityScore facilityScore : facilityScoreRepository.findByFormXpathScoreMappingAndLastVisitDataIsLiveTrueAndLastVisitDataAreaParentAreaIdInAndLastVisitDataTimPeriodTimePeriodIdAndLastVisitDataIsFinalizedTrue(formXpathScoreMapping,Arrays.asList(UserAreaId),timeperiodId) ) {
					...
					if (facilityScore.getLastVisitData().isLive()
							&& facilityScore.getLastVisitData().getArea()
									.getParentAreaId().equals(UserAreaId) ) {
...
//		.getDataByparentIdsInSectorIdIdAndDistrictAreaId(sectorId, areaId,timeperiodId);
		...
		choiceMap.put(0, "Poor");
		choiceMap.put(1, "Fair");
		choiceMap.put(2, "Good");
		for (Object[] childlastVisitData : childlastVisitDatas) {
			...
			indMap.put("value", childlastVisitData[1] == null ? 0
			...
			for (Object[] childnodelastVisitData : lastVisitDataRepository
				...
				if(childnodelastVisitData[0].toString().contains("D.2.4"))
				System.out.println(childnodelastVisitData[0]);
				...
				if(childnodelastVisitData[4].toString().equalsIgnoreCase("select_one yes_no")|| childnodelastVisitData[4].toString().equalsIgnoreCase("integer"))
				{
					...
					}else if(childnodelastVisitData[4].toString().equalsIgnoreCase("integer")) {
						childMap.put("value", childnodelastVisitData[1] == null ? "N/A"
								: childnodelastVisitData[1]);
					}
				...
				else if(childnodelastVisitData[0].toString().contains("D.3.") && childnodelastVisitData[2]==null) {
					
					childMap.put("value", childnodelastVisitData[1] == null ? "N/A"
							:choiceMap.get(Integer.parseInt(childnodelastVisitData[1].toString().substring(0, 1))));
					
					childMap.put("response", true);
					childMap.put("color", color4);
				}else if(childnodelastVisitData[4].toString().equalsIgnoreCase("decimal")) {
					childMap.put("response", true);
					childMap.put("color", color4);
				}
				else
