...
//	boolean generateIndicatorXpathMapping() throws Exception;
	...
	boolean updateFormXpathScoreMapping() throws Exception;
	
	boolean updateAspirationalArea(List<Integer> areaIds) throws Exception;
	
	boolean updateAreaLevel() throws Exception;
