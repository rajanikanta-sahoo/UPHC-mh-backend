...
public interface ODKService {
	...
	boolean sendSubmitionFormReport() throws Exception;
	
	boolean finalizeLastVisitData(int lastvistitDataId);
	
	boolean aproveAndFinalizeLastVisitData(int lastvistitDataId);
