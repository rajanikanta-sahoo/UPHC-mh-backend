...
public interface FacilityScoreRepository {
	...
	List<Object[]> findSpiderDataChartByFormIdForDistrictForDGAOfAspirational(Integer formMetaId,
			Integer parenXpathId, Integer areaId, int timeperiodId);
	
	List<Object[]> findSpiderDataChartByFormIdForDistrictOfAspirational(
			 Integer formMetaId,Integer parenXpathId,Integer areaId,int timeperiodId);
	
	List<Object[]> findSpiderDataChartByFormIdOfAspirational(
			 Integer formMetaId,Integer parenXpathId,int timeperiodId);
	
	List<Object[]> findSpiderDataChartByLasatVisitDatAndFormIdAndTimePeriodIdOfAspirational(
			Integer formMetaId,Integer areaId,Integer parenXpathId,int timeperiodId);
	
	
	List<Object[]> findSpiderDataChartByFormIdOfAspirationalNational(
			 Integer formMetaId,Integer parenXpathId,int timeperiodId,List<Area> states);
	
	List<Object[]> getDataForAspirationalNational(
			 Integer formMetaId,List<Integer> timeperiodIds,List<Integer> states);
	
	List<Object[]> getDataForAspirationalNationalSpiderData(
			 Integer formMetaId,List<Integer> timeperiodIds,List<Integer> states,List<Integer>parenXpathId);
	
	List<Object[]> getDataForAspirationalNationalSpiderDataWithStates(
			 Integer formMetaId,List<Integer> timeperiodIds,List<Integer> states,List<Integer>parenXpathId);
}
