...
public interface XFormRepository {
	...
	List<TimePeriod> findDistinctTimPeriodByStateAreaIdAndProgramIdForRawData(int stateId, int programId);
	
	List<TimePeriod> findDistinctTimPeriodByStateAreaIdAndProgramIdAndTimePeriodState(int stateId, int programId);
	
	List<XForm> findByIsLiveTrueAndTimePeriodTimePeriodId(int timePeriodId);
	
	List<XForm> findByIsLiveTrueAndStateAreaId(int stateId);

	List<TimePeriod> findDistinctTimPeriodByStateAreaIdAndProgramIdAndTimePeriodState2(int stateId, int programId);
}
