...
public class HeaderFooter extends PdfPageEventHelper {
	...
	public HeaderFooter(String domainName,String stateId) {
	...
	public void onStartPage(PdfWriter writer, Document document) {
		...
		try
		{
				image = Image.getInstance(ResourceUtils.getFile("classpath:templates/header_"+this.stateId+".png").getAbsolutePath());
