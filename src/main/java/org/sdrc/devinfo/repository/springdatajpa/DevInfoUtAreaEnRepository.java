...
public interface DevInfoUtAreaEnRepository extends
	...
	@Override
	@Query("Select area from UtAreaEn area where area.area_Level=:level And area.area_Parent_NId =:parentId")
	public List<UtAreaEn> getAllAreaByLevelAndParentAreaId(@Param("level") Integer level,@Param("parentId") int parentId);
	...
	@Override
	@Query("Select area from UtAreaEn area where area.area_Parent_NId=:parentId")
	public List<UtAreaEn> findByParentId(@Param("parentId") int parentId);
	
	@Override
	@Query("Select area.area_Name from UtAreaEn area where area.area_NId=:areaNId")
	public String findByAreaNId(@Param("areaNId") int areaNId);
